...
supervised_input_receiver_fn = (
    tf.contrib.estimator.build_raw_supervised_input_receiver_fn(
        {'batter1': tf.placeholder(dtype=tf.float32, shape=[None]),
         'batter2': tf.placeholder(dtype=tf.float32, shape=[None]),
         'batter3': tf.placeholder(dtype=tf.float32, shape=[None]),
         'batter4': tf.placeholder(dtype=tf.float32, shape=[None]),
         'batter5': tf.placeholder(dtype=tf.float32, shape=[None]),
         'batter6': tf.placeholder(dtype=tf.float32, shape=[None]),
         'batter7': tf.placeholder(dtype=tf.float32, shape=[None]),
         'batter8': tf.placeholder(dtype=tf.float32, shape=[None]),
         'batter9': tf.placeholder(dtype=tf.float64, shape=[None]),
         'batter10': tf.placeholder(dtype=tf.float32, shape=[None]),
         'batter11': tf.placeholder(dtype=tf.float32, shape=[None]),
         'batter12': tf.placeholder(dtype=tf.float32, shape=[None]),
         'pitcher1': tf.placeholder(dtype=tf.float32, shape=[None]),
         'pitcher2': tf.placeholder(dtype=tf.float32, shape=[None])},
        tf.placeholder(dtype=tf.float32, shape=[None])))

serving_input_receiver_fn = (
    tf.estimator.export.build_parsing_serving_input_receiver_fn(
        tf.feature_column.make_parse_example_spec(construct_feature_columns(training_examples))))
